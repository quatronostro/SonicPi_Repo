...
with_fx :distortion, mix: 0.1 do
  live_loop :kick, sync: :bar do
    if tracker[3]>0 then
      sample "C:/Users/Berke/Music/AbleforSonic2023/frenchKick.wav", amp: 0.99
...
live_loop :trap, sync: :bar do
  if tracker[4]>0 then
    sample "C:/Users/Berke/Music/AbleforSonic2023/frenchTrap.wav", amp: 1.1
    sleep 4
  else
    sleep 1
  end
...
with_fx :gverb, mix: line(0.1, 0.5, steps: 10).mirror.tick do
  live_loop :bremen, sync: :bar do
    if tracker[5]>0 then
      sample "C:/Users/Berke/Music/AbleforSonic2023/bremen.wav", amp: 1, cutoff: line(90, 130, steps: 4).mirror.look
      sleep 8
    else
      sleep 1
    end
...
with_fx :ixi_techno, mix: 0.4 do
  live_loop :perc, sync: :bar do
    if tracker[10]>0 then
      sample "C:/Users/Berke/Music/AbleforSonic2023/percussion.wav", amp: 1.19
      sleep 16
    else
      sleep 1
    end
